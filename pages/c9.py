                                    ...
                                    children=[
                                            ...
                                            children=[
                                                html.Div(
                                                    children=[
                                                        html.Div(
                                                            children=[
                                                                html.P("A: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent pharetra et arcu sit amet congue. Ut sed lacus eu ipsum elementum consequat et ut metus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed a magna at ex condimentum sodales nec nec sem. Aenean eget enim porta, consequat est non, ultrices ex."),
                                                                html.P("Searched Documents: Document_contract_1.pdf, page 2, 15 ,40"),
                                                            ],
                                                            style={"marginLeft": "5px"},
                                                        ),
                                                    ],
                                        ...
                                        html.Div(
                                            [
                                                dbc.Row(
                                                    [
                                                        dbc.Col(dbc.Input(type="text", placeholder="Ask a question..."), width=8),
                                                        dbc.Col(dbc.Button("Send", color="primary", className="mb-2", style = {"width":"150px","marginLeft":"10px"}), width=3)
                                                    ],
                                                    className="g-0"
                                                ),
                                            ...
                                            style={
                                                ...
                                                "border-radius": "5px",  # Optional: if you want rounded corners
                                                "color": "white" ,
                                                "marginTop":"40px" # Change text color to white if needed
                                            }
                                        ),# Add your text here
                                    ],
                                    style={
                                        ...
                                        "borderRadius": "30px",  # Rounded corners like in the image
